...
Resonance2 is an AI-powered application built by the Meta App Factory.

**What it does:** Multi-agent therapeutic application
...
2. Run `launch_resonance2.bat` (Windows) or `python bridge.py` (any OS)
