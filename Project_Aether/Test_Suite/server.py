"""
Test_Suite — FastAPI Backend Server
...
logging.basicConfig(level=logging.INFO, format="%(asctime)s [Test_Suite] %(message)s")
logger = logging.getLogger("Test_Suite")
logger.info(f"Runtime dir: {RUNTIME_DIR}")

app = FastAPI(title="Test_Suite API", version="3.0")
...
@app.get("/")
def root():
    return {"service": "Test_Suite", "version": "3.0", "streaming": STREAMING, "port": DEFAULT_PORT}
