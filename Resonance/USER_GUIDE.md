...
Resonance is an AI-powered application built by the Meta App Factory.

**What it does:** Multi-agent educational app for teenagers with auditory processing challenges
...
2. Run `launch_resonance.bat` (Windows) or `python bridge.py` (any OS)
...
---
*Auto-generated by Meta App Factory on 2026-03-02*
