...
```bash
docker build -t resonance4 .
docker run -p 5000:5000 --env-file .env resonance4
```
...
```bash
# Windows
launch_resonance4.bat

# Linux/macOS
chmod +x launch_resonance4.sh && ./launch_resonance4.sh
```
