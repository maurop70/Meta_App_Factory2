"""
Resonance4 — FastAPI Backend Server
...
logging.basicConfig(level=logging.INFO, format="%(asctime)s [Resonance4] %(message)s")
logger = logging.getLogger("Resonance4")
logger.info(f"Runtime dir: {RUNTIME_DIR}")

app = FastAPI(title="Resonance4 API", version="3.0")
...
@app.get("/")
def root():
    return {"service": "Resonance4", "version": "3.0", "streaming": STREAMING, "port": DEFAULT_PORT}
