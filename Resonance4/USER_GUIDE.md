...
Resonance4 is an AI-powered application built by the Meta App Factory.

**What it does:** Test app
...
2. Run `launch_resonance4.bat` (Windows) or `python bridge.py` (any OS)
